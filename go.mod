module github.com/metadiv-go-tech/module_motor_garage
...
require (
	...
	github.com/metadiv-go-tech/metaorm/v2 v2.3.9
	github.com/metadiv-go-tech/mod_dev_auth/v2 v2.0.0
	github.com/metadiv-go-tech/module_relationship/v2 v2.4.1
	github.com/metadiv-go-tech/module_system_data/v2 v2.2.1
)
